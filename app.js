...
function markVoiceConfirmedSession(){voiceConfirmed=true;try{sessionStorage.setItem('naviVoiceConfirmedThisSession','1')}catch(e){}}
...
function fitActiveRouteOverview(animate=false){
    ...
    const compact=matchMedia('(orientation: landscape) and (max-height: 620px)').matches;
    map.invalidateSize({pan:false});
    map.fitBounds(bounds,{paddingTopLeft:compact?[44,42]:[80,110],paddingBottomRight:compact?[52,46]:[90,120],animate});
}
